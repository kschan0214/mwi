...
%
%
function fitRes = mwi_2T13T2s_cx_VFAT2s_fixedT2siew(algoPara,imgPara)
...
%         ub = double([Amwub,Aiwub,Aewub,t2smwub,t2siwub,t2sewub,t1sub,t1lub,fmwub,fiwub,klsub,totalFieldub,piniub]);
        x0 = double([Amw0 ,Aiw0 ,Aew0 ,t2smw0 ,t2siw0  ,t1s0 ,t1l0 ,fmw0 ,fiw0  ,kls0,totalField0,pini0]);
        lb = double([Amwlb,Aiwlb,Aewlb,t2smwlb,t2siwlb,t1slb,t1llb,fmwlb,fiwlb,klslb,totalFieldlb,pinilb]);
        ub = double([Amwub,Aiwub,Aewub,t2smwub,t2siwub,t1sub,t1lub,fmwub,fiwub,klsub,totalFieldub,piniub]);
    else
        % set initial guess and fitting boundaries
