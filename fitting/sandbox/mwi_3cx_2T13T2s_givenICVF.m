...
%
%
function fitRes = mwi_3cx_2T13T2s_givenICVF(algoPara,imgPara)
        ...
        for ky=1:ny
            parfor kx=1:nx
                if mask(ky,kx,kz)>0
                    ...
                    icvf0   = icvf(ky,kx,kz);
                    [estimates(ky,kx,kz,:),resnorm(ky,kx,kz)] = FitModel(s,fa,te,tr,b1,icvf0,db0,pini0,npulse,numMagn,isWeighted,weightMethod,isNormCost,isInvivo,userDefine,options,DEBUG);
                end
            end
            % display progress
...
function [x,res] = FitModel(s,fa,te,tr,b1,icvf,db0,pini,npulse,numMagn,isWeighted,weightMethod,isNormCost,isInvivo,userDefine,options,DEBUG)
...
fmw0 = 5;   fmwlb = -40; fmwub = 40;
fiw0 = -1;  fiwlb = -25; fiwub = 25;
