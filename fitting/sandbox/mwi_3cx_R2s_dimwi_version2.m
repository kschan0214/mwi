...
function [x,res] = FitModel(s,te,icvf0,theta0,ff0,db0,pini0,DIMWI,fitAlgor,userDefine,isInvivo,options,DEBUG)
if DEBUG
...
[x,res] = lsqnonlin(@(y)CostFunc(y,s,te,DIMWI,fitAlgor,DEBUG),x0,lb,ub,options);
