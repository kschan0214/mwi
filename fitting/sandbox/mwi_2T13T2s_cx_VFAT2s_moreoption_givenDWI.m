...
%
%
function fitRes = mwi_2T13T2s_cx_VFAT2s_moreoption_givenDWI(algoPara,imgPara)
...
for kfa = 1:length(fa)
    ...
    sHat(kfa,:) = mwi_model_3cc_nam2015(te,Amw_curr,Aiw_curr,Aew_curr,t2smw,t2siw,t2sew,fmwbg,fiwbg,totalfield(kfa),pini(kfa));
end
