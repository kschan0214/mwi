...
%
%
function fitRes = mwi_2T13T2s_cx_VFAT2s_fixedT1k(algoPara,imgPara)
...
%         ub = double([Amwub,Aiwub,Aewub,t2smwub,t2siwub,t2sewub,t1sub,t1lub,fmwub,fiwub,klsub,totalFieldub,piniub]);
        x0 = double([Amw0 ,Aiw0 ,Aew0 ,t2smw0 ,t2siw0 ,t2sew0 ,t1s0  ,fmw0 ,fiw0  ,totalField0,pini0]);
        lb = double([Amwlb,Aiwlb,Aewlb,t2smwlb,t2siwlb,t2sewlb,t1slb,fmwlb,fiwlb,totalFieldlb,pinilb]);
        ub = double([Amwub,Aiwub,Aewub,t2smwub,t2siwub,t2sewub,t1sub,fmwub,fiwub,totalFieldub,piniub]);
    else
        % set initial guess and fitting boundaries
