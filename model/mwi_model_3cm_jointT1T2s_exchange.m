%% s = mwi_model_3cm_jointT1T2s_exchange(fa,te,tr,Amy,Aax,Aex,t2smy,t2sax,t2sex,t1my,t1ax,t1ex,fmy,fax,kmyax,kmyex,b1,isT2sExchange)
%
% Input
% --------------
% fa            : flip angles
...
%
%
function s = mwi_model_3cm_jointT1T2s_exchange(fa,te,tr,Amy,Aax,Aex,t2smy,t2sax,t2sex,t1my,t1ax,t1ex,fmy,fax,kmyax,kmyex,b1,isT2sExchange)
...
if isT2sExchange
    ...
    L2s = -[1/t2smy,0,0;0,1/t2sax,0;0,0,1/t2sex] + Fs;
end
