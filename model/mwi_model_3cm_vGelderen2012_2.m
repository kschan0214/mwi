%% s = mwi_model_3cm_vGelderen2012_2(te,s0,mwf,iacf,t2smy,t2sax,t2sex,fmy,fax)
%
...
function s = mwi_model_3cm_vGelderen2012_2(te,s0,mwf,iacf,t2smy,t2sax,t2sex,fmy,fax)

s = s0.*abs(  mwf   .* exp(te.*(-1./t2smy-1i*2*pi.*fmy)) + ...
            (1-mwf) .*(   iacf   .*exp(te.*(-1./t2sax-1i*2*pi.*fax)) + ...
                        (1-iacf) .*exp(te.*(-1./t2sex))));
