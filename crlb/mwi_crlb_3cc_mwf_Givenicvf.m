...
%
%
function [fim, crlb] = mwi_crlb_3cc_mwf_Givenicvf(te,sigma,S0,mwf,icvf,r2s_mw,r2s_iw,r2s_ew,w_mb,w_ib,w_eb,phi)
...
%         dSdtheta = [dSdS0;dSdmwf;dSdicvf;dSdr2s_mw;dSdr2s_iw;dSdr2s_ew;dSdw_mb;dSdw_ib;dSdw_eb;dSdphi];
    dSdtheta = [dSdS0;dSdmwf;dSdr2s_mw;dSdr2s_iw;dSdr2s_ew;dSdw_mb;dSdw_ib;dSdw_eb;dSdphi];
