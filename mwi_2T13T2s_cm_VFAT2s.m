...
function [x,res] = FitModel(s,fa,te,tr,b1,npulse,numMagn,isWeighted,userDefine,options,DEBUG)
...
% run lsqnonlin!
[x,res] = lsqnonlin(@(y)CostFunc(y,s,fa,te,tr,b1,npulse,T3D_all,numMagn,isWeighted,DEBUG),x0,lb,ub,options);

end

%% compute the cost function of the optimisation problem
function err = CostFunc(x,s,fa,te,tr,b1,npulse,T3D_all,numMagn,isWeighted,DEBUG)
